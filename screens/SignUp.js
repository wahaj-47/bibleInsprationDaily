...
class SignUp extends React.PureComponent {
  ...
  handleSignUpPressed = () => {
    axios
      .post(
        "https://dailyinspiredhub.com/api/get_nonce/?controller=user&method=signup"
      )
      .then(({ data }) => {
        axios
          .post(
            `https://dailyinspiredhub.com/api/user/signup?username=${this.state.username}&display_name=${this.state.name}&email=${this.state.email}&user_pass=${this.state.password}&nonce=${data.nonce}`
          )
          .then(({ data }) => {
            data.error
